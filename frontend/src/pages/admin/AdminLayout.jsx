...
const adminApiRequest = async (endpoint, options = {}) => {
  ...
  // PRODUCTION FIX: Read body as text directly (no clone needed)
  let rawText = '';
  try {
...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { icon: Gift, label: 'Custom Benefits', path: '/admin/custom-benefits' },
    ...
    { icon: Sliders, label: 'Commission Controls', path: '/admin/commission-controls' },
    { icon: AlertTriangle, label: 'Fraud Analytics', path: '/admin/fraud-analytics' },
