...
const FacebookGroupWidget = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      setTimeout(() => setWidgetReady(true), 2000);
    };
  ...
  return (
    <div className="bg-card rounded-xl shadow-sm mb-4 overflow-hidden" data-testid="facebook-group-widget-container">
      ...
      <div 
        ...
        className="relative"
        style={{ 
          minHeight: showFallback ? '300px' : '500px',
          maxHeight: '700px',
          overflowY: 'auto',
        }}
      >
        ...
        {/* Taggbox Widget Container - only render if ID is set */}
        {TAGGBOX_WIDGET_ID && !error && (
          <div 
            id={`taggbox-widget-${TAGGBOX_WIDGET_ID}`}
            style={{ 
              width: '100%',
              minHeight: '500px',
        ...
        {/* Promotional Fallback - shown when no widget ID or error */}
        {showFallback && (
          <div className="p-6">
            {/* Community Info Card */}
            <div className="bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-pink-900/20 rounded-xl p-5 border border-blue-500/20 mb-4">
              <div className="flex items-center gap-3 mb-4">
                <div className="relative">
                  <div className="absolute inset-0 bg-blue-500/30 rounded-full blur-lg"></div>
                  <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-full w-14 h-14 flex items-center justify-center">
                    <Facebook className="w-7 h-7 text-white" />
                  </div>
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg">BlendLink.net Community</h3>
                  <p className="text-blue-300 text-sm">Join our Facebook Group</p>
                </div>
              </div>
              ...
              <div className="bg-gray-800/50 rounded-lg p-4 mb-4">
                <div className="flex items-center gap-2 text-yellow-400 mb-2">
                  ...
                  <span className="font-semibold">Earn BL Coins!</span>
                </div>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Join our community group to connect with other members, share your minted photos, and earn rewards for engagement!
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                <div className="bg-gray-800/40 rounded-lg p-3 text-center">
                  ...
                  <span className="text-xs text-gray-400">Community Chat</span>
                </div>
                <div className="bg-gray-800/40 rounded-lg p-3 text-center">
                  <Share2 className="w-5 h-5 text-green-400 mx-auto mb-1" />
                  <span className="text-xs text-gray-400">Share & Earn</span>
                </div>
              </div>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-semibold transition-all shadow-lg shadow-blue-500/20"
                data-testid="join-group-btn"
              >
                <Facebook className="w-5 h-5" />
                Join BlendLink Group on Facebook
                <ExternalLink className="w-4 h-4" />
              </a>
            </div>
          </div>
