  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" data-testid="photo-editor-modal">
      <div className="bg-background rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {/* Uploading overlay - Animated spinner during photo uploads */}
        {isUploading && (
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-background p-8 rounded-2xl flex flex-col items-center gap-4 min-w-[320px] shadow-2xl border border-border">
              {/* Animated upload spinner with gradient */}
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full blur-xl opacity-40 animate-pulse" />
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">Please wait while your photos are being uploaded</p>
              </div>
