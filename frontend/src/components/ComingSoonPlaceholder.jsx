...
const ComingSoonPlaceholder = ({ 
  icon: Icon,
  title = "Coming Soon",
  description = "This feature is coming soon to the web version"
}) => {
  const openApp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
      ...
      <p className="text-muted-foreground mb-6 max-w-sm">
        {description} — available now in the native Blendlink app!
      </p>

      {/* CTA to open/download app */}
      <Button
        size="lg"
        className="rounded-full mb-4"
        onClick={openApp}
        data-testid="open-native-app-btn"
      >
