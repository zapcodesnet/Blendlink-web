...
export const TappingArena = ({
  ...
  }, [winner, soundEnabled, vibrate, onRoundComplete, playerTaps, opponentTaps, playerRequiredTaps, opponentRequiredTaps, playerEffectiveValue, opponentEffectiveValue, timeRemaining]);
